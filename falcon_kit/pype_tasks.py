...
python -m falcon_kit.mains.bam2dexta --config-fn={input.config} split  --wildcards={params.wildcards} --bam-fofn-fn={input.bam_fofn} --split-fn={output.split} --bash-template-fn={output.bash_template}
"""
...
python -m falcon_kit.mains.bam2dexta --config-fn={input.config} combine  --gathered-fn={input.gathered} --dexta-fofn-fn={output.dexta_fofn}
"""
